...
To upgrade from v1 to the new Amplify Library for Swift, you can follow the [upgrade guide](/lib/project-setup/upgrade-guide/#structured-concurrency-asyncawait-pattern).
